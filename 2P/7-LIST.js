...
(function Usarlistas(){
    ...
    let listaHeri = new lista;
    listaHeri .insertHead(nodo5)
    listaHeri .insertHead(nodo4)
    listaHeri .insertHead(nodo3)
    listaHeri .insertHead(nodo2)
    listaHeri .insertHead(nodo1)
